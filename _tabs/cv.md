...
1 | CVE-2023-46892 | Unauthorized function execution through replaying radio signals  
  | 2023 | [Meross MSH30Q smart thermostat](https://www.cve.org/CVERecord?id=CVE-2023-46892)
2 | CVE-2023-46889 | Decrypting the protected Wi-Fi router password  
  | 2023 | [Meross MSH30Q smart thermostat](https://www.cve.org/CVERecord?id=CVE-2023-46889)
3 | CVE-2023-42144 | Sniffing Wi-Fi router credentials during device setup  
  | 2023 | [Shelly TRV smart thermostat](https://www.cve.org/CVERecord?id=CVE-2023-42144)
4 | CVE-2023-42143 | Updating the device with a manipulated firmware through MitM  
  | 2023 | [Shelly TRV smart thermostat](https://www.cve.org/CVERecord?id=CVE-2023-42143)  
5 | CVE-2024-48122 | Privilege escalation through insecure default configurations  
  | 2022 | [HI-SCAN 6040i Hitrax HX-03-19-I](https://nvd.nist.gov/vuln/detail/CVE-2024-48122)
6 | CVE-2024-48123 | Arbitrary code execution via USB AutoRun scripting  
  | 2022 | [HI-SCAN 6040i Hitrax HX-03-19-I](https://nvd.nist.gov/vuln/detail/CVE-2024-48123)
7 | CVE-2024-48126 | Hardcoded credentials for critical functionality access  
  | 2022 | [HI-SCAN 6040i Hitrax HX-03-19-I](https://nvd.nist.gov/vuln/detail/CVE-2024-48126)
8 | CVE-2024-48121 | Man-in-the-middle to the cleartext communication over the GIOP protocol  
  | 2022 | [HI-SCAN 6040i Hitrax HX-03-19-I](https://nvd.nist.gov/vuln/detail/CVE-2024-48121)
9 | CVE-2024-48125 | Enumerating user credentials through unauthorized GIOP requests  
  | 2022 | [HI-SCAN 6040i Hitrax HX-03-19-I](https://nvd.nist.gov/vuln/detail/CVE-2024-48125)
10 | CVE-2021-34594 | Unauthenticated any file manipulation through relative path traversal  
   | 2021 | [TwinCAT OPC UA Server](https://cert.vde.com/en/advisories/VDE-2021-051/)
{: reversed="reversed"}
